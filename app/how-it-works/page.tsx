...
const HowItWorksPage = () => {
    return (
        <main className="mt-20 relative isolate max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-bold mb-6">
                Meal Planner Website - How it Works
            </h1>
            ...
            <section className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2">
                    <li><Link href={"/register"} target="_blank">Sign up for an account.</Link></li>
