...
const GlowyBanner: React.FC<GlowyBannerProps> = ({
  ...
  return (
    <div className="mx-auto relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 max-w-7xl sm:px-3.5 sm:before:flex-1 z-10">
