// components/meal/IngredientSearch.tsx
...
import { fetchFood } from "@/lib/edamam";
...
const MealIngredientSearch: React.FC<MealIngredientSearchProps> = ({
  mealId,
  updateAllMealIngredients, // api call to get all meal nutrients
}) => {
  ...
  const handleAddIngredient = () => {
    if (selectedFoodHint) {
      ...
      const mealIngredient: IMealIngredient = {
        mealId: mealId || 0,
...
export default MealIngredientSearch;
